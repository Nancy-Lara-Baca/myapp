      ...
      body: PageView(
        ...
        children: <Widget>[
          makePage(
            ...
            title: 'F1Store',
            description: 'Mercancia para fanáticos de Formula 1'
          ),
          makePage(
            page: 2,
            image: 'assets/images/ferrari.png',
            title: 'Mercancia de Ferrari',
            description: 'En esta pagina encontraras la mejor mercanicia de Ferrari'
          ),
          makePage(
            page: 3,
            image: 'assets/images/redbull.png',
            title: 'Mercancia de Red Bull',
            description: "Desde objetos coleccionables hasta ropa de tus equipos favoritos"
          ),
          makePage(
            page: 4,
            image: 'assets/images/mercedes.png',
            title: 'Mercancia de Mercedes',
            description: "Tu tienda favorita de tus equipos favoritos"
          ),
        ],
      ),
    );
